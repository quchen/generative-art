...
import qualified Steps.A.HelloWorld
import qualified Steps.B.Squares
import qualified Steps.C.PlanetMotion
...
main = do
    ...
    drawToFiles "bob2022/c_planetMotion" 800 800 (Steps.C.PlanetMotion.planetMotion)
