...
main = png >> svg
  where
    png = withSurface PNG "out/haskell_logo_billard.png" picWidth picHeight renderDrawing
    svg = withSurface SVG "out/haskell_logo_billard.svg" picWidth picHeight renderDrawing
