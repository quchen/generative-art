    ...
    newCutsEdgeMapBuilder scissors@(Line scissorsStart _) cuts = go cutPointsSorted
      where
        ...
        classifyCut ((False, p), (False, q)) = case (sideOfScissors p, sideOfScissors q) of
            ...
            _other -> error "Point on scissors that is has not been recorded as such! [A]"
        classifyCut ((False, p), (True,  _)) = case sideOfScissors p of
            LeftOfLine  -> LOO
            RightOfLine -> ROO
            _other -> error "Point on scissors that is has not been recorded as such! [B]"
        classifyCut ((True, _), (False, q)) = case sideOfScissors q of
            LeftOfLine  -> OOL
            RightOfLine -> OOR
            _other -> error "Point on scissors that is has not been recorded as such! [C]"
