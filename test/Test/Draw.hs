...
boundingBoxEllipseTest = testVisual "Bounding box" 300 300 "docs/geometry/ellipse_bounding_boxes" $ \(w,h) -> do
    ...
    paintWithBB 0 2 (G.transform (G.shear 0.9 0 <> G.scale' 0.5 1) ellipse)
    paintWithBB 1 2 (G.transform (G.shear 0 (-0.9) <> G.scale' 1 0.5) ellipse)
    paintWithBB 2 2 (G.transform (G.rotate (deg 30) <> G.shear 0 (-0.5) <> G.scale' 1 0.5) ellipse)
