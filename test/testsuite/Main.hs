...
import qualified Test.Data.Grid
...
import qualified Test.Geometry.Algorithms.WaveFunctionCollapse
...
tests = testGroup "Test suite"
    ...
    , Test.Geometry.Algorithms.WaveFunctionCollapse.tests
